...
(doom! :input
       ...
       ophints           ; An indicator for “what did I just do?”
       ...
       (whitespace +trim) ; trim trailing whitespace on save
       ...
       (debugger +lsp)          ; FIXME stepping through code, to help you add bugs, golang needs: lldb
       direnv
       (docker +lsp) ; https://docs.doomemacs.org/latest/modules/tools/docker/
       ;;editorconfig      ; let someone else argue about tabs vs spaces
       ;;ein               ; tame Jupyter notebooks with emacs
       (eval +overlay)     ; run code, run (also, repls)
       ;;gist              ; interacting with github gists
       (lookup +dictionary +docsets)              ; navigate your code and its documentation
       (lsp +peek ) ; TODO check compatibility with other modules: +eglot)               ; M-x vscode
       ...
       ;; deprecated taskrunner        ; taskrunner for all your projects
       ...
       (python +lsp +pyenv +pyright)           ; beautiful is better than ugly, https://docs.doomemacs.org/v21.12/modules/lang/python/
       ;;qt                ; the 'cutest' gui framework ever
       ;;racket            ; a DSL for DSLs
       ;;raku              ; the artist formerly known as perl6
       ;;rest              ; Emacs as a REST client
       ;;rst               ; ReST in peace (reStructuredText)
